...
const CANONICAL = "https://fraldageriatrica.com/";
...
// ───── V2 Hero: split layout com imagem
const Hero = () => (
  <section className="relative pt-28 pb-16 lg:pt-36 lg:pb-24 overflow-hidden">
    ...
    <div className="max-w-6xl mx-auto px-6 relative z-10">
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div className="flex flex-col">
          <ScrollReveal delay={0}>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/[0.04] border border-white/[0.08] mb-8 w-fit">
          ...
          <ScrollReveal delay={0.1}>
            <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-semibold text-white tracking-tighter-custom mb-6 leading-[1.05]">
              Fralda geriátrica{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 to-sky-500">
                de graça pelo SUS.
              </span>
              <br />
              <span className="text-white/80 font-light text-3xl sm:text-4xl lg:text-[2.5rem]">
                A gente emite o laudo médico online.
              </span>
            </h1>
          </ScrollReveal>

          <ScrollReveal delay={0.2}>
            <p className="text-lg text-white/65 mb-8 leading-relaxed font-light max-w-xl">
          ...
          <ScrollReveal delay={0.3}>
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
              <Button
                asChild
                size="lg"
                className="rounded-full px-8 py-6 text-base bg-sky-500 hover:bg-sky-400 text-[#070B12] font-bold shadow-xl shadow-sky-500/30 hover:shadow-sky-400/50 hover:-translate-y-1 hover:scale-[1.02] active:scale-95 transition-all duration-300 group overflow-hidden relative border border-sky-400/50"
                data-cta-id="hero-primary"
              >
                <a href={WHATSAPP} className="flex items-center gap-2 relative justify-center">
                  ...
                  <span className="relative z-10 tracking-tight">Quero minha fralda</span>
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="rounded-full px-8 py-6 text-base bg-white/[0.03] border-white/15 text-white hover:bg-white/[0.06] hover:text-white gap-2"
        ...
        <ScrollReveal delay={0.2}>
          <div className="relative">
            <div className="absolute -inset-4 bg-gradient-to-br from-sky-500/20 via-sky-400/5 to-transparent rounded-[2rem] blur-2xl" />
            <div className="relative rounded-2xl overflow-hidden border border-white/[0.08] shadow-2xl shadow-sky-500/10">
              <img
                src="/medico.jpg"
                alt="Médico na Farmácia Popular com fralda geriátrica gratuita do SUS"
            ...
            {/* Badge flutuante */}
            <div className="absolute -bottom-4 -left-4 bg-[#0d1320] border border-sky-400/25 rounded-2xl p-4 shadow-xl backdrop-blur-sm">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-sky-500/15 flex items-center justify-center">
                  <ShieldCheck className="w-5 h-5 text-sky-400" />
                </div>
                <div>
                  <p className="text-xs font-semibold text-white">Laudo ICP-Brasil</p>
                  <p className="text-[10px] text-white/50">Assinatura digital válida</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <ScrollReveal delay={0.5}>
        <div className="mt-16 flex flex-wrap justify-center items-center gap-6 sm:gap-8">
...
// ───── V2 Como funciona: com imagem de teleconsulta
const steps = [
  {
    num: "01",
    title: "Preenchimento online",
    desc: "Você preenche os dados do paciente e envia a documentação básica direto pelo nosso site em poucos minutos.",
    Icon: ClipboardCheck,
  },
  {
    num: "02",
  ...
  <section id="como-funciona" className="py-24 border-b border-white/[0.06]">
    <div className="max-w-6xl mx-auto px-6">
      ...
      <div className="grid lg:grid-cols-5 gap-8 items-start">
        {/* Imagem teleconsulta */}
        <ScrollReveal delay={0} className="lg:col-span-2 hidden lg:block">
          <div className="sticky top-28">
            <div className="relative rounded-2xl overflow-hidden border border-white/[0.08]">
              <img
                src="/images/site/3.png"
                alt="Médica realizando teleconsulta para emissão de laudo de fralda geriátrica"
                className="w-full h-auto object-cover aspect-[1/1]"
                width={500}
                height={500}
                loading="lazy"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#070B12]/50 via-transparent to-transparent" />
              <div className="absolute bottom-0 left-0 right-0 p-5">
                <p className="text-xs font-medium text-white/90">Teleconsulta médica</p>
                <p className="text-[10px] text-white/60 mt-0.5">100% online, pelo celular ou computador</p>
              </div>
            </div>
          </div>
        </ScrollReveal>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  {step.highlight && (
                    <a
                      href={WHATSAPP}
                      className="mt-5 inline-flex items-center gap-2 text-sky-300 text-[10px] font-semibold uppercase tracking-widest transition-all hover:text-sky-200 drop-shadow-[0_0_8px_rgba(56,189,248,0.8)] hover:drop-shadow-[0_0_12px_rgba(56,189,248,1)] cursor-pointer"
                    >
                      <span className="w-1.5 h-1.5 rounded-full bg-sky-400 animate-pulse-dot shadow-[0_0_10px_rgba(56,189,248,1)]" />
                      Entrega no mesmo dia
                    </a>
                  )}
                </div>
                <step.Icon
                  className={`absolute -bottom-8 -right-8 w-[140px] h-[140px] -rotate-12 ${
      ...
      {/* Imagem mobile (visível só no mobile) */}
      <ScrollReveal delay={0.2}>
        <div className="mt-8 lg:hidden rounded-2xl overflow-hidden border border-white/[0.08]">
          <img
            src="/images/site/3.png"
            alt="Médica realizando teleconsulta para emissão de laudo de fralda geriátrica"
...
// ───── V2 Para quem: com imagem lifestyle
const ParaQuem = () => (
  <section className="py-24 border-b border-white/[0.06]">
    <div className="max-w-6xl mx-auto px-6">
      ...
      {/* Imagem panorâmica de família */}
      <ScrollReveal delay={0.05}>
        <div className="mb-8 relative rounded-2xl overflow-hidden border border-white/[0.08]">
          <img
            src="/img/peace_of_mind_elderly.png"
            alt="Família brasileira com avós e netos reunidos"
            className="w-full h-48 sm:h-64 object-cover object-[center_20%]"
            width={1200}
            height={400}
            loading="lazy"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#070B12]/70 via-[#070B12]/30 to-[#070B12]/70" />
          <div className="absolute inset-0 flex items-center justify-center">
            <p className="text-white/90 font-semibold text-lg sm:text-2xl tracking-tight text-center px-6">
        ...
        {[
          {
            ...
            img: "/idosos_felizes.png",
            imgAlt: "Casal de idosos caminhando feliz em parque",
          ...
          },
          {
            ...
            img: "/images/site/1.png",
            imgAlt: "Pessoa idosa sorrindo em ambiente acolhedor",
          ...
          <ScrollReveal key={b.title} delay={i * 0.1}>
            <div className={`rounded-3xl ${SURFACE} ${SURFACE_HOVER} overflow-hidden h-full transition-all`}>
              {/* Imagem no card */}
              <div className="relative h-48 overflow-hidden">
                <img
                  src={b.img}
                  alt={b.imgAlt}
                  className={`w-full h-full object-cover ${b.imgPosition || ""}`}
                  width={600}
                  height={300}
                  loading="lazy"
                />
                ...
                <div className="absolute bottom-4 left-6">
                  <div className="w-10 h-10 rounded-xl bg-sky-500/20 border border-sky-500/30 flex items-center justify-center backdrop-blur-sm">
...
// ───── V2 Quanto custa: com imagem de produto
const QuantoCusta = () => (
  <section className="py-24 border-b border-white/[0.06]">
    <div className="max-w-5xl mx-auto px-6">
      ...
      <div className="grid lg:grid-cols-5 gap-6 items-stretch">
        {/* Imagem do produto */}
        <ScrollReveal delay={0} className="lg:col-span-2 hidden lg:flex">
          <div className="relative rounded-2xl overflow-hidden border border-white/[0.08] bg-gradient-to-br from-white/[0.04] to-transparent flex items-center justify-center p-8 w-full">
            <img
              src="/fralda_tecnologia.png"
              alt="Fralda geriátrica de alta tecnologia"
              className="w-full max-w-[280px] h-auto object-contain drop-shadow-[0_0_30px_rgba(56,189,248,0.15)]"
              width={400}
              height={400}
              loading="lazy"
            />
            <div className="absolute bottom-6 left-6 right-6">
              <p className="text-[10px] uppercase tracking-widest text-sky-400 font-semibold">Farmácia Popular</p>
              <p className="text-xs text-white/60 mt-1">Fralda geriátrica 100% gratuita pelo SUS</p>
            </div>
          </div>
        </ScrollReveal>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-white/[0.05] to-white/[0.01] border border-white/[0.08] p-8 sm:p-10">
            ...
            <div className="relative z-10">
              ...
              <Button
                asChild
                size="lg"
                className="w-full rounded-full py-6 text-base bg-sky-500 hover:bg-sky-400 text-[#070B12] font-bold shadow-xl shadow-sky-500/30 hover:shadow-sky-400/50 hover:-translate-y-1 hover:scale-[1.02] active:scale-95 transition-all duration-300 group overflow-hidden relative border border-sky-400/50"
                data-cta-id="pricing-primary"
              >
                <a href={WHATSAPP} className="flex items-center gap-2 relative justify-center">
                  <span className="absolute inset-0 w-full h-full bg-white/20 blur-md translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out" />
                  <Sparkles className="w-5 h-5 relative z-10" />
                  <span className="relative z-10 tracking-tight">Quero meu laudo</span>
                  <ArrowRight className="w-5 h-5 relative z-10 transition-transform group-hover:translate-x-1" />
                </a>
              </Button>
...
// ───── V2 CTA final: com imagem do médico assinando laudo
const CtaFinal = () => (
  <section className="py-24">
    <div className="max-w-5xl mx-auto px-6">
      <ScrollReveal>
        <div className="relative overflow-hidden rounded-3xl border border-sky-400/20 bg-gradient-to-br from-sky-500/[0.10] via-white/[0.02] to-transparent">
          ...
          <div className="grid lg:grid-cols-5 items-stretch">
            ...
            <div className="lg:col-span-2 relative hidden lg:block">
              <img
                src="/img/hero_laudo_mockup.png"
                alt="Médico assinando laudo para fralda geriátrica"
                className="w-full h-full object-cover"
                width={500}
                height={600}
                loading="lazy"
              />
              <div className="absolute inset-0 bg-gradient-to-r from-transparent to-[#070B12]/60" />
            </div>

            {/* Texto */}
            <div className="lg:col-span-3 p-10 sm:p-14 flex flex-col justify-center relative z-10">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-sky-500/10 border border-sky-400/25 mb-6 w-fit">
                <Sparkles className="w-3.5 h-3.5 text-sky-400" />
                <span className="text-[10px] font-semibold uppercase tracking-widest text-sky-300">
                  Atendimento humano, hoje
                </span>
              </div>
              <h2 className="text-3xl sm:text-4xl font-semibold text-white tracking-tighter-custom mb-4 leading-tight">
              ...
              <Button
                asChild
                size="lg"
                className="w-full sm:w-auto rounded-full px-8 py-6 text-base bg-sky-500 hover:bg-sky-400 text-[#070B12] font-bold shadow-xl shadow-sky-500/30 hover:shadow-sky-400/50 hover:-translate-y-1 hover:scale-[1.02] active:scale-95 transition-all duration-300 group overflow-hidden relative border border-sky-400/50"
                data-cta-id="cta-final"
              >
                <a href={WHATSAPP} className="flex items-center gap-2 relative justify-center">
                  <span className="absolute inset-0 w-full h-full bg-white/20 blur-md translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out" />
                  <Sparkles className="w-5 h-5 relative z-10" />
                  <span className="relative z-10 tracking-tight">Começar meu pedido</span>
                  <ArrowRight className="w-5 h-5 relative z-10 transition-transform group-hover:translate-x-1" />
                </a>
              </Button>
            </div>
