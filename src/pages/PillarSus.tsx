  ...
  return (
    <main className={`${BG} min-h-screen text-white`}>
      <SEO 
        ...
        canonicalPath="/fralda-geriatrica-gratis-sus"
        keywords="fralda geriátrica grátis SUS, Farmácia Popular fralda, como retirar fralda SUS, documentos fralda geriátrica, Portaria 3073 fralda"
        jsonLd={[
          {
