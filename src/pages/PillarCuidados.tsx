  ...
  return (
    <main className={`${BG} min-h-screen text-white`}>
      <SEO 
        ...
        canonicalPath="/cuidar-de-idoso-em-casa"
        keywords="cuidar de idoso em casa, cuidados domiciliares idoso, cuidador de idoso, recursos SUS idoso, guia cuidado idoso"
        jsonLd={[
          {
